...
public class ModedSchematics extends Schematics {
    ...
    public Seq<BuildPlan> toPlans(Schematic schem, int x, int y) {
        ...
        return schem.tiles.map(t -> new BuildPlan(t.x + dx, t.y + dy, t.rotation, t.block, t.config))
                .removeAll((BuildPlan plan) -> !plan.block.unlockedNow())
                .sort(Structs.comparingInt((BuildPlan plan) -> -plan.block.schematicPriority));
    }
